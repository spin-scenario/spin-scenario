...
reduce_phantom{z0=175, z1=175, dx=4, dy=4} -- SEE NOTE for detail. 
...
local gyspoil =trapGrad{axis ="Y", area = math.pi*2*1e3/42.57/(240/64), width =3}
...
-- experimental study.
result =run{exp =se, phantom ="mida.h5"} 
