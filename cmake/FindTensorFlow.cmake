# edited by Cecilia Curreli, 2018
#original version from Patrick Wieschollek, <mail@patwie.com>
...
execute_process(COMMAND python3 -c "import sys; print(sys.executable);" OUTPUT_VARIABLE PYTHON_EXECUTABLE OUTPUT_STRIP_TRAILING_WHITESPACE)
...
# Compiles a CPU + GPU operation with invoking NVCC
  ...
  add_library(${op_name}_op_cu SHARED ${kernel_file})
  #consider also cuda_add_library(${op_name}_op_cu SHARED ${kernel_file})
